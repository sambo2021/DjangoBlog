...
def ListStudentDetails(request, st_id):
    st = Student.objects.get(id = st_id)
    context = {'st': st}
    return render(request,'blogapp/st-details.html', context)

@login_required(login_url='login')
def home(request):
    all_student =  Student.objects.all()
    conxt = {'students': all_student}
    return render(request,'blogapp/home.html', conxt)
...
def addStudent(request):
    ...
    return render(request, 'blogapp/add-student.html', context)
